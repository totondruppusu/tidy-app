         ...
         <div className="settings-grid">
            ...
            <div className="settings-row">
              ...
              <select
                ...
                onChange={(event) => layout.setViewMode(event.target.value as ViewMode)}
                disabled={isLoading}
              >
            ...
            <div className="settings-row">
              ...
              <select
                ...
                onChange={(event) => layout.setSortMode(event.target.value as SortMode)}
                disabled={isLoading}
              >
            ...
            <div className="settings-row">
              ...
              <select
                ...
                onChange={(event) => layout.handleGroupModeChange(event.target.value as GroupMode)}
                disabled={isLoading || layout.shouldGroupDuplicates}
              >
                <option value="none">None</option>
                <option value="type">Type</option>
                <option value="extension">Extension</option>
                {layout.shouldGroupDuplicates && <option value="duplicates">Duplicates</option>}
              </select>
            </div>
            <div className="settings-row">
              <div className="setting-info">
              ...
              <select
                ...
                onChange={(event) => layout.setExtensionFilterMode(event.target.value as ExtensionFilterMode)}
                disabled={isLoading}
              >
            ...
            <div className="settings-row">
              ...
              <select
                ...
                onChange={(event) => layout.setListDensity(event.target.value as DensityMode)}
                disabled={isLoading}
              >
            ...
            <div className="settings-row">
              ...
              <label className="setting-toggle">
                <input type="checkbox" checked={scanning.autoScanOnPick} onChange={(event) => scanning.setAutoScanOnPick(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              ...
              <label className="setting-toggle">
                <input type="checkbox" checked={scanning.rememberLastFolder} onChange={(event) => scanning.setRememberLastFolder(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              ...
              <label className="setting-toggle">
                <input type="checkbox" checked={scanning.includeSubfolders} onChange={(event) => scanning.setIncludeSubfolders(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              ...
              <label className="setting-toggle">
                <input type="checkbox" checked={scanning.includeHidden} onChange={(event) => scanning.setIncludeHidden(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              ...
              <label className="setting-toggle">
                <input type="checkbox" checked={cleanup.useHashForDuplicates} onChange={(event) => cleanup.setUseHashForDuplicates(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              ...
              <select
                ...
                onChange={(event) => cleanup.setDuplicateMinSizeBytes(Number(event.target.value))}
                disabled={isLoading}
              >
            ...
            <div className="settings-row">
              ...
              <select
                ...
                onChange={(event) => cleanup.setTrashBehavior(event.target.value as TrashBehavior)}
                disabled={isLoading}
              >
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <div className="setting-subtitle">
                  {cleanup.trashBehavior === "permanent" ? "Permanent delete always asks for confirmation." : "Show a confirmation dialog before deleting."}
                </div>
              </div>
              <label className={`setting-toggle${cleanup.confirmTrash ? "" : " is-warning"}`}>
                <input type="checkbox" checked={cleanup.confirmTrash} onChange={(event) => cleanup.setConfirmTrash(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              ...
              <label className="setting-toggle">
                <input type="checkbox" checked={preview.autoPlayMedia} onChange={(event) => preview.setAutoPlayMedia(event.target.checked)} disabled={isLoading} />
            ...
            <div className="settings-row">
              <div className="setting-info">
                ...
                <div className="setting-subtitle">Disable previews over {formatBytes(LARGE_PREVIEW_SIZE_BYTES)}.</div>
              </div>
              <label className="setting-toggle">
