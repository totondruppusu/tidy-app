...
export const SuggestionsModal = ({
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      backdropClassName="suggestions-backdrop"
    >
          ...
          <div className="suggestions-shell">
            <div className="suggestions-main">
                  ...
                  >
                    {modeOptions.map((option) => (
                      <button
                        ...
                        onClick={() =>
                          controller.setSuggestionsMode(option.value)
                        }
                      >
                        {option.label}
                      </button>
              ...
              <div className="suggestions-controls suggestions-controls-selection">
                ...
                <button
                  ...
                  onClick={() =>
                    controller.updateSuggestionSelection(() =>
                      controller.visibleSuggestions.map(
              ...
              <div className="suggestions-meta">
                ...
                <span>
                  {controller.selectedSuggestions.length} selected actions
                </span>
              </div>
              ...
              {controller.visibleSuggestions.length === 0 ? (
                ...
                <div className="suggestions-list">
                  {controller.visibleSuggestions
                    .slice(0, 120)
                    .map((suggestion) => (
                      <label key={suggestion.id} className="suggestion-item">
                        <input
                          type="checkbox"
                          checked={controller.selectedSuggestionSet.has(
                            suggestion.id,
                          )}
                          onChange={(event) => {
                        ...
                        <span className="suggestion-main">
                          ...
                          <span className="suggestion-subtitle">
                            {controller.getSuggestionActionLabel(
                          ...
                          <span className="suggestion-subtitle mono">
                            {controller.formatSuggestionPath(
            ...
            <aside className="suggestions-preview-panel">
              ...
              <div className="suggestions-preview-summary">
                ...
                <span>
                  Visible selected:{" "}
                  {controller.selectedVisibleSuggestions.length}/
              ...
              <div className="suggestions-preview-list">
                {controller.selectedSuggestions.length === 0 ? (
                  ...
                  controller.selectedSuggestions
                    ...
                    .map((suggestion) => {
                      const dryRunResult =
                        controller.suggestionDryRunResultsById.get(
                          suggestion.id,
                        );
                      const previewStatus =
                        controller.hasDryRunPreviewForSelection
                    ...
                    Object.entries(controller.selectedSuggestionActionCounts)
                      ...
                      .map(([actionType, count]) => (
                        <span key={actionType} className="suggestion-chip">
                          {controller.getSuggestionActionLabel(actionType)}:{" "}
                          {count}
                        </span>
                      ))
                  )}
